...
if (isset($_GET['sort'])) {
    ...
    $currentLink = 'listings2.php?search-name=' . $name . '&search-category=' . $category . '&search-state' . $state;
}
//If search has not been submitted
    ...
    $stmt -> execute();
    $result = $stmt -> fetchAll();
    $currentLink = 'listings2.php?search-name=&search-category=0&search-state=0';
}
?>
